...
var _View_MessageInputComponent0 = (function (_super) {
    ...
    _View_MessageInputComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_16 = this.renderer.createText(this._el_15, 'Clear', null);
    ...
    _View_MessageInputComponent0.prototype._handle_click_15_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
...
export function viewFactory_MessageInputComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageInputComponent === null)) {
        (renderType_MessageInputComponent = viewUtils.createRenderComponentType('C:/Users/Rahul/Desktop/Udemy/MEAN/messenger/assets/app/messages/message-input.component.html', 0, import9.ViewEncapsulation.None, styles_MessageInputComponent, {}));
    }
