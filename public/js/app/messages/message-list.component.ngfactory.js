...
export function viewFactory_MessageListComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageListComponent === null)) {
        (renderType_MessageListComponent = viewUtils.createRenderComponentType('C:/Users/Rahul/Desktop/Udemy/MEAN/messenger/assets/app/messages/message-list.component.ts class MessageListComponent - inline template', 0, import9.ViewEncapsulation.None, styles_MessageListComponent, {}));
    }
